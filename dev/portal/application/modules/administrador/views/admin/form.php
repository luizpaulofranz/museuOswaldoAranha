...
echo '<br/><a class="btn btn-primary  alteraFonte" href="' . base_url('admin/administrador/pg') . '"><span class="glyphicon glyphicon-arrow-left"></span> Voltar</a>';
echo '</div></div>';
...
echo form_fieldset();
/* Input = Nome */
echo '<div class="form-group alteraFonte">';
...
echo '</div></div>';
?>
<div class="form-group alteraFonte">
...
echo form_button(array('type' => 'submit', 'name' => 'button', 'id' => 'enviar', 'class' => 'btn btn-success alteraFonte', 'value' => 'Cadastrar'), '<span class="glyphicon glyphicon-floppy-disk"></span> Salvar');
echo '</div></div>';
echo form_close();
?>