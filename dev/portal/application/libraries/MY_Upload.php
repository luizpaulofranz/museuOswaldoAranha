...
/**
 * 
 * Biblioteca de upload que acrescenta a funcionalidade de multi-upload de 
 * arquivos.
 * Sua usabilidade continua exatamente igual a nativa, o que muda é que a função
 * data agora retornam um array multi dimencional (matriz), cada posição 
 * contendo informações sobre cada arquivo que foi feito upload.
 * 
 * Acrescentado o atributo multi, que é quem indica a funcionalidade de 
 * multiupload. O mesmo pode receber 'all', que retorna erro e não faz o upload
 * caso ocorra algum erro ocorra em qualquer um dos arquivos.
 * 'ignore' que ignora esses erros e tenta prosseguir com o upload dos demais 
 * arquivos e por fim:
 * 'halt' que faz o upload até encontrar o promeiro erro, então paraliza.
 * 
 * @package	CodeIgniter
 * @author	Adrian Voicu adapted for Luiz Paulo Franz
 * @since	Version 1.0.0
 * @filesource
 */
