...
//server
$db['server']['hostname'] = 'mysql.moseragro.com.br';
$db['server']['username'] = 'moseragro';
$db['server']['password'] = 'minhasenha';
$db['server']['database'] = 'moseragro';
$db['server']['dbdriver'] = 'pdo_mysql';
$db['server']['dbprefix'] = '';
